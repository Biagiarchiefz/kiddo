    ...
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="max-w-md">
        ...
        <DialogFooter>
          ...
          <Button
            onClick={() => user && onSave(user.id, form)}
  ...
  return (
    <AdminLayout>
      <div className="space-y-5">
        ...
        <Card className="border border-border overflow-hidden py-0 gap-0 min-w-140">
              ...
              : paginated.map((u, i) => (
                  ...
                  >
                    ...
                    <Avatar className="w-8 h-8 shrink-0">
                      <AvatarFallback
                        className={`text-xs font-bold ${u.role === "admin" ? "bg-amber-100 text-amber-700" : "bg-sky-100 text-sky-700"}`}
                      >
                    ...
                    {/* Email */}
                    <p className="w-28 text-xs text-muted-foreground truncate">
                      {u.email}
                    </p>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              Hapus akun "{deleteTarget?.username}"?
            </AlertDialogTitle>
            <AlertDialogDescription>
              Email: {deleteTarget?.email}. Semua data pengguna ini akan
              terhapus permanen.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
